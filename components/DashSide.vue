...
<template>
    <nav class="sidebar px-1">
        <div class="bg-base-100 text-content content-center h-screen pr-1">
            <ul class="menu rounded-box pt-3">
                <li>
                    <NuxtLink to="/dashboard">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-base-content w-6" viewBox="0 0 256 256">
                            <path
                        ...
                        <span class="text-base-content">Overview</span>
                    </NuxtLink>
                </li>
                <li>
                    <details close>
                        <summary class="shake group after:text-base-content after:opacity-40">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="fill-base-content w-6 group-hover:fill-secondary-focus" viewBox="0 0 256 256">
                                <path
                            ...
                            <span class="text-base-content">Groups</span>
                        </summary>
                        <ul class="text-base-content">
                            <li>
                                <NuxtLink to="/groups">
                                    <span class="text-base-content">My Groups</span>
                                </NuxtLink>
                            </li>
                            <li>
                                <NuxtLink to="/groups/create">
                                    <span class="text-base-content">Create Group</span>
                                </NuxtLink>
                            </li>
                        </ul>
                    </details>
                ...
                <li>
                    <NuxtLink to="/invites" class="shake group">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-base-content w-6 group-hover:fill-accent-focus"
                            viewBox="0 0 256 256">
                            <path
                        ...
                        <div class="indicator">
                            <span
                                class="indicator-item badge-sm rounded-full badge-accent bg-accent-focus text-xs px-1.5 text-neutral-content font-normal opacity-90">
                                <!-- {!invites ? "0" : invites} -->
                            </span>
                            <span class="mt-0 mr-2.5 text-base-content">Invites</span>
                        </div>
                    </NuxtLink>
                </li>
                <li>
                    <details close>
                        <summary class="shake group after:text-base-content after:opacity-40 hover">
                            <svg xmlns="http://www.w3.org/2000/svg" class="fill-base-content w-6 group-hover:fill-info"
                                viewBox="0 0 256 256">
                                <path
                            ...
                            <span class="text-base-content">Receipts</span>
                        </summary>
                        <ul class="text-base-content">
                            <li>
                                <a>My Receipts</a>
                            ...
                            <li>
                                <NuxtLink to="/receipts/upload">
                                    <span class="text-base-content mb-1">
                                        Upload Receipt
                                    </span>
                                </NuxtLink>
                            </li>
                ...
                <li>
                    <a class="shake">
                        <svg xmlns="http://www.w3.org/2000/svg" class="fill-base-content w-6 -scale-x-100"
                            viewBox="0 0 256 256">
                            <path
                        ...
                        <span class="text-base-content">Circuit</span>
                    </a>
                </li>
            </ul>
        </div>

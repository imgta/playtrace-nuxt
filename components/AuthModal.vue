...
<dialog ref="popLogin" class="modal">
    ...
    <div v-if="popSwitch === 'login'" :class="formBg" method="dialog" class="modal-box w-auto max-fit px-9 pb-3 shadow-none">
        ...
        <div class="card-body pt-5 pb-1.5 bg-none">
            ...
            <button class="modal-action justify-center label-text-alt text-neutral-content/75 hover:text-neutral-content font-extralight link link-hover mx-0 px-0" @click="formSwitch">
...
<dialog ref="popSignUp" class="modal">
    <div v-if="popSwitch === 'signup'" :class="formBg" method="dialog" class="modal-box w-auto max-fit px-9 pb-3 shadow-none">
        <h1 class="text-primary text-4xl text-center pt-4 pr-1.5 pb-0.5">
            Register.
        </h1>
        <p class="text-neutral-content/80 text-center text-sm">

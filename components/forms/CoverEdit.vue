...
async function getGiphy(query: string, offset: number, limit: number): Promise<string[]> {
    try {
        ...
        // Note: fetching .webp images breaks when query is 'cats'
        ...
        <div class="modal-box max-w-4xl p-10 shadow-none bg-primary-content/95">
            ...
            <div class="flex justify-center items-center">
                ...
                <div class="query-container">
                    <input v-model="coverQuery" type="search" class="input input-bordered input-primary form-input search pl-9" placeholder="Search" />

    ...
    <div class="pt-6">
        <div v-if="clickAPI === 'splash'">
            <MasonryWall :items="pics" :ssr-columns="3" :min-columns="3" :column-width="250" :gap="12">
                <template #default="{ item }">
                    <button>
                        <img :src="item" alt="PICs" class="object-contain cursor-pointer hover:brightness-110 hover:contrast-75 hover:opacity-90" @click="selectCover(item, false)" />
                    </button>
                </template>
            </MasonryWall>
        </div>
        <div v-if="clickAPI === 'giphy'">
            <MasonryWall :items="gifs" :ssr-columns="3" :min-columns="3" :column-width="250" :gap="12">
                <template #default="{ item }">
                    <button>
                        <img :src="item" alt="GIFs" class="object-contain cursor-pointer hover:brightness-110 hover:contrast-75 hover:opacity-90" @click="selectCover(item, false)" />
                    </button>
                </template>
            </MasonryWall>
        </div>

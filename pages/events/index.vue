...
<template>
    ...
    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 px-8 md:px-8 py-8">
        <div v-for="(ev, idx) in mapEventsDestruct(myId)" :key="idx" class="card card-compact bg-base-100 not-prose">
            ...
            <div class="py-2.5 px-5">
                <div class="pb-6">
                    <div class="flex justify-center">
                        <h1 class="text-primary text-lg md:text-2xl font-medium">{{ ev.title }}</h1>
                    </div>
                    <div class="flex justify-center">

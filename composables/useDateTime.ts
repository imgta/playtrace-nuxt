export default function () {
    function formatDays(datetime: string): string {
    ...
    function dashDate(datetime: string): string {
    ...
    function articleDate(datetime: any) {
        const options = {
            year: 'numeric',
            month: 'long',
            day: 'numeric',
    ...
    function shortDate(datetimeInput: string): string {
    ...
    return { formatDays, dashDate, articleDate, shortDate };
}
